...
public class Signup extends HttpServlet{
    public void doGet(HttpServletRequest req,HttpServletResponse res){
        ...
        try{
            ...
            if(flag==1){
                Cookie signUpCookie = new Cookie("signUpDetails", "false");
                Cookie loginCookie = new Cookie("loggedIn", "false");
                res.addCookie(signUpCookie);
                res.addCookie(loginCookie);
                pw.println("The given username: "+name+" is already taken! Please try other username<br>");
                pw.println("<a href=\"http://localhost:8080/1005_ex5/new_account.html\">Click here to go to signup page</a>");
            }
            else{
                Cookie signUpCookie = new Cookie("signUpDetails", "true");
                ...
                pw.println("<form action=\"http://localhost:8080/1005_ex5/event.html\" method=\"get\">");
